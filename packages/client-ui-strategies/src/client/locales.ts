...
export const zh: Record<StrategyLocaleKey, string> = {
      ...
      'sv.mgmt.confirmDelete': '确定删除该策略？内置策略删除后可随时「恢复默认」找回。',
      'sv.mgmt.confirmOverride': '该 ID 与内置策略同名，保存将覆盖内置策略（可随时恢复默认）。继续？',
...
export const en: Record<StrategyLocaleKey, string> = {
      ...
      'sv.mgmt.confirmDelete': 'Delete this strategy? Deleted built-in strategies can be restored anytime via "Restore".',
      'sv.mgmt.confirmOverride': 'This ID collides with a built-in strategy. Saving will override it (restorable anytime). Continue?',
