...
export const zh: Record<StrategyLocaleKey, string> = {
      ...
      'sv.mgmt.confirmOverrideScreener': '该 ID 与内置选股器同名，保存将覆盖内置选股器（可随时恢复出厂代码；本次修改保存后删除/恢复将不可找回）。继续？',
...
export const en: Record<StrategyLocaleKey, string> = {
      ...
      'sv.mgmt.confirmOverrideScreener': 'This ID collides with a built-in screener. Saving will override it (factory code stays restorable; once saved, this modification is unrecoverable on delete/restore). Continue?',
