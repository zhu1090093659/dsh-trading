...
export const zh: Record<MarketLocaleKey, string> = {
      ...
      'trade.mode.paper': '模拟交易 (Demo)',
      'trade.paper.tag': '模拟盘 (虚拟资金)',
      'trade.paper.reset': '重置模拟金',
      'trade.paper.resetConfirm': '确认将模拟账户重置为初始资产 (100,000) 吗？',
      'trade.paper.available': '可用虚拟',
...
export const en: Record<MarketLocaleKey, string> = {
      ...
      'trade.mode.paper': 'Demo (Paper)',
      'trade.paper.tag': 'Demo (Virtual)',
      'trade.paper.reset': 'Reset Balance',
      'trade.paper.resetConfirm': 'Reset demo account to initial balance (100,000)?',
      'trade.paper.available': 'Virtual Available',
      'trade.paper.buyAction': 'Demo Buy',
      'trade.paper.sellAction': 'Demo Sell',
      'trade.paper.drawerTag': 'Demo Ledger',
      'trade.paper.initialBalance': 'Initial Balance',
      'trade.paper.totalPnl': 'Demo Total P&L',
