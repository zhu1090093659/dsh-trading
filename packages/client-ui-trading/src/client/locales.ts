...
export const zh: Record<MarketLocaleKey, string> = {
      ...
      'compose.data.indicators': '已开指标参数：{list}；可用 {tool} 同参数复算，或取数后自行计算。',
...
export const en: Record<MarketLocaleKey, string> = {
      ...
      'compose.data.indicators': 'Active indicators: {list} — recompute via {tool} with the same params, or compute from the fetched klines.',
