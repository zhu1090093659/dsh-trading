...
function dictionaries(): Record<'zh' | 'en', Record<MarketLocaleKey, string>> {
  return {
    zh: {
      ...
      'strategy.horizon.swing': '中线波段',
      'strategy.horizon.long': '长线投资',
      'strategy.metrics.totalReturn': '累计收益率',
      'strategy.metrics.cagr': '年化收益 (CAGR)',
      'strategy.metrics.maxDrawdown': '最大回撤',
      'strategy.metrics.sharpe': '夏普比率 (Sharpe)',
      'strategy.metrics.winRate': '胜率 (Win Rate)',
      'strategy.metrics.profitFactor': '盈亏比 (Profit Factor)',
      'strategy.metrics.tradeCount': '交易总笔数',
      'strategy.metrics.tradeUnit': '笔',
      'strategy.metrics.exposure': '市场暴露度',
      'strategy.run': '运行回测',
      'strategy.running': '回测计算中...',
      'strategy.symbolLabel': '标的:',
      'strategy.intervalDaily': '(日K)',
      'strategy.error.noKlines': '未能获取到历史 K 线行情数据',
      'strategy.error.failed': '回测执行失败',
      'strategy.trades.title': '交易明细记录',
      'strategy.trades.entryTime': '入场时间',
      'strategy.trades.exitTime': '出场时间',
      'strategy.trades.entryPrice': '买入价',
      'strategy.trades.exitPrice': '卖出价',
      'strategy.trades.holdingBars': '持仓(K线)',
      'strategy.trades.netReturn': '净盈亏%',
      'strategy.trades.exitReason': '平仓原因',
      'strategy.trades.empty': '回测周期内无完整平仓交易记录',
      'strategy.empty.hint': '点击「运行回测」计算策略历史表现',
    ...
    en: {
      ...
      'strategy.metrics.tradeCount': 'Trade Count',
      'strategy.metrics.tradeUnit': 'trades',
      'strategy.metrics.exposure': 'Exposure',
      'strategy.run': 'Run Backtest',
      'strategy.running': 'Running...',
      'strategy.symbolLabel': 'Symbol:',
      'strategy.intervalDaily': '(1D)',
      'strategy.error.noKlines': 'Failed to fetch historical klines data',
      'strategy.error.failed': 'Backtest execution failed',
      'strategy.trades.title': 'Trade History',
      ...
      'strategy.trades.empty': 'No closed trades in backtest period',
      'strategy.empty.hint': 'Click "Run Backtest" to evaluate strategy historical performance',
